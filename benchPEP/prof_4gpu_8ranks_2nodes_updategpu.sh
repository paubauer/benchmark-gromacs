...
mpirun --hostfile ./hosts --byslot -x HIP_VISIBLE_DEVICES=0,1,2,3 --mca pml ucx \
       -np 8 ./set_mpi_affinities_2nodes_4gpus_8ranks.sh \
       ./helper_rocprof.sh $ROOT/Gromacs-mpi/build-mpi/bin/gmx_mpi mdrun \
       -nsteps 100 -v -stepout 100 -noconfout -nstlist 300 \
