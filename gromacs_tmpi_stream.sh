...
gmx mdrun -pin on -nsteps 100000 -resetstep 90000 -ntmpi 4 -ntomp 16 -noconfout -nb gpu -bonded gpu -pme gpu -npme 1 -v -gpu_id 0123 -nstlist 400 -dlb yes -s topol.tpr 2>&1 | tee -a ${OUT_FILE}

# 8GPUs
echo "benchmark,adh_dodec,gpus_8,rank_4,thread_4" | tee -a ${OUT_FILE}
gmx mdrun -pin on -nsteps 100000 -resetstep 90000 -ntmpi 8 -ntomp 4 -noconfout -nb gpu -bonded gpu -pme gpu -npme 1 -v -gpu_id 01234567 -nstlist 400 -dlb yes -s topol.tpr 2>&1 | tee -a ${OUT_FILE}
